...
function Auth() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      navigate("/AgregarJugadores"); // Redirige a la página deseada después de autenticarse
    } catch {
      Swal.fire({
        icon: "error",
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      navigate("/AgregarJugadores"); // Redirige a la página deseada después del registro
    } catch {
      Swal.fire({
        icon: "error",
        title: "Oops...",
